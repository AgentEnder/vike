import{o as S,a as T}from"../chunks/chunk-C8vnCRJQ.js";import{j as e,a as t}from"../chunks/chunk-DbV7nHd1.js";import{L as r}from"../chunks/chunk-DLDxwuYb.js";/* empty css                      */import{a as C}from"../chunks/chunk-DFo3DYfP.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{O as F}from"../chunks/chunk-7j5OQDDi.js";/* empty css                      *//* empty css                      */import{Q as P}from"../chunks/chunk-B6ToWE3g.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-N50ObCN8.js";const b="#a00",w="#0a0",V="#e90";function h(){return e.jsx(e.Fragment,{children:" |"})}function z(){return e.jsx("span",{style:{color:w,fontSize:"1.9em",display:"block"},children:"✓"})}function O(){return e.jsx("span",{style:{color:b,fontSize:"1.6em",display:"block"},children:"✗"})}function I({value:s}){const u=m(),o=N(s);return e.jsx("div",{className:"value-gauge",style:{height:9,borderWidth:1,borderStyle:"solid",borderColor:"#ddd",borderRadius:10,display:"flex",padding:"1px 2px"},children:e.jsx("div",{style:{height:"100%",width:u,backgroundColor:o,borderRadius:10}})});function m(){return t(s>0&&s<100),"calc("+s/100+" * 100%)"}}function N(s){return t(s>0&&s<100),s<50?b:s>=75?w:V}function p({name:s,children:n}){return e.jsxs(e.Fragment,{children:[e.jsx("em",{children:s}),": ",n]})}function L({entries:s,skip_links:n}){return e.jsx("div",{className:"values-table",children:e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx(o,{children:""}),e.jsx(o,{children:"Trans­parent"}),e.jsx(o,{children:"Fork­able"}),e.jsx(o,{children:"Access­ible"}),e.jsx(o,{children:"Sustai­nable"}),e.jsx(o,{children:"Inde­pendent"})]})}),e.jsx("tbody",{children:s.map((i,l)=>e.jsx(u,{...i},l))})]})});function u({modelName:i,transparent:l,forkable:d,accessible:j,independent:k,sustainable:v}){return e.jsxs("tr",{children:[e.jsx(a,{children:i}),e.jsx(a,{children:e.jsx(c,{val:l})}),e.jsx(a,{children:e.jsx(c,{val:d})}),e.jsx(a,{children:e.jsx(c,{val:j})}),e.jsx(a,{children:e.jsx(c,{val:v})}),e.jsx(a,{children:e.jsx(c,{val:k})})]})}function o({children:i,...l}){if(t(Object.keys(l).length===0),!i)return e.jsx("th",{});const d=i,j=n?d:e.jsx("a",{href:m(d),children:d});return e.jsx("th",{align:"center",children:j})}function m(i){return t(i.constructor===String),t(!i.includes("&shy;"),{value_name:i}),t(!i.includes("%C2%AD"),{value_name:i}),"/values"}function a({children:i}){return e.jsx("td",{align:"center",children:i})}function c({val:i}){return t(0<=i&&i<=1),i===1?e.jsx(z,{}):i===0?e.jsx(O,{}):e.jsx(I,{value:i*100})}}function A(){return e.jsx(e.Fragment,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("em",{children:"Transparent"}),": anyone can read the code."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Forkable"}),": anyone can modify the code and publish its own version."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Accessible"}),": anyone can use the code, no matter how much money at disposal."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Sustainable"}),": the project's developers are financially supported."]}),e.jsxs("li",{children:[e.jsx("em",{children:"Independent"}),": the project isn't influenced by outside interests."]})]})})}function y(s){const n={li:"li",p:"p",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(L,{entries:[{modelName:e.jsx(e.Fragment,{children:"Open Source Pricing"}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Donations"]}),transparent:1,forkable:1,accessible:1,independent:1,sustainable:.3},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Company Backed"]}),transparent:1,forkable:1,accessible:1,independent:0,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Open Source",e.jsx(h,{})," Open Core"]}),transparent:.7,forkable:.7,accessible:.7,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Public Source"]}),transparent:1,forkable:0,accessible:.45,independent:1,sustainable:1},{modelName:e.jsxs(e.Fragment,{children:["Proprietary Software",e.jsx(h,{})," Closed Source"]}),transparent:0,forkable:0,accessible:.45,independent:1,sustainable:1}],skip_links:!0}),`
...
`]}),`
`]})]})}function R(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(y,{...s})}):y(s)}const $=[["1$ - 50$","1$ - 100$","1$ - 200$"],["50$ - 100$","100$ - 200$","200$ - 500$"],["100$ - 200$","200$ - 500$","500$ - 1000$"]].map(s=>s.map(n=>n.replaceAll(" "," "))),g=["Small organization","Midsize organization","Large organization"],x=["≤2 regular committers","Hobby use case"],D=["Small use case","Midsize use case","Large use case"],_="≥3 regular committers",E=[...x,...D],M=()=>e.jsx("div",{className:"table-container",children:e.jsx("table",{className:"responsive-table",children:e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"row-header"}),g.map((s,n)=>e.jsx("td",{className:"column-header",children:s},n))]}),E.map((s,n)=>e.jsxs("tr",{children:[e.jsxs("td",{className:"row-header",children:[s,n>0&&e.jsx("div",{className:"subtext",children:_})]}),g.map((u,o)=>e.jsx("td",{className:"price-cell",children:n<x.length?e.jsx("strong",{children:"Free"}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"price-container",children:[e.jsx("strong",{children:$[n-x.length][o]}),e.jsx("span",{className:"price-subtext",children:" / month"})]}),e.jsx("div",{className:"recommendation",children:"Recommended"})]})},o))]},n))]})})}),W=[{pageSectionId:"pricing",pageSectionLevel:4,pageSectionTitle:"Pricing"},{pageSectionId:"open-source-pricing",pageSectionLevel:4,pageSectionTitle:"Open Source Pricing"},{pageSectionId:"who-pays-and-how-much",pageSectionLevel:2,pageSectionTitle:"Who pays and how much?"},{pageSectionId:"free-tier",pageSectionLevel:3,pageSectionTitle:"Free tier"},{pageSectionId:"recommendation",pageSectionLevel:3,pageSectionTitle:"Recommendation"},{pageSectionId:"do-sponsors-have-to-pay",pageSectionLevel:2,pageSectionTitle:"Do sponsors have to pay?"},{pageSectionId:"how-does-it-apply-to-monorepos",pageSectionLevel:2,pageSectionTitle:"How does it apply to monorepos?"},{pageSectionId:"how-does-it-work",pageSectionLevel:2,pageSectionTitle:"How does it work?"},{pageSectionId:"why-zero-investors",pageSectionLevel:2,pageSectionTitle:"Why zero-investors?"},{pageSectionId:"is-vike-still-free-software",pageSectionLevel:2,pageSectionTitle:"Is Vike still Free Software?"},{pageSectionId:"why-not-another-business-model",pageSectionLevel:2,pageSectionTitle:"Why not another business model?"}];function f(s){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(C,{children:[e.jsx(n.p,{children:"The Open Source Pricing isn't implemented yet."}),e.jsxs(n.p,{children:["Questions welcome at ",e.jsx(n.a,{href:"https://github.com/vikejs/vike/discussions/1932",children:"#1932"}),"."]})]}),`
`,e.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:37,marginBottom:30},children:e.jsx("img",{src:F,style:{maxWidth:"100%"}})}),`
`,e.jsx(P,{style:{marginTop:60,marginBottom:45},children:"Paying for Open Source isn't a bug — it's a feature: it ensures Vike's interests are aligned with yours."}),`
