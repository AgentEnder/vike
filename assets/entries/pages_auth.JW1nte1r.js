import{o as a,a as t}from"../chunks/chunk-C8vnCRJQ.js";import{j as e,b as o}from"../chunks/chunk-DbV7nHd1.js";import{L as n}from"../chunks/chunk-DLDxwuYb.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const i=[{pageSectionId:"pagecontext-user",pageSectionLevel:2,pageSectionTitle:"`pageContext.user`"},{pageSectionId:"ssg",pageSectionLevel:2,pageSectionTitle:"SSG"},{pageSectionId:"login-flow",pageSectionLevel:2,pageSectionTitle:"Login flow"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"In principle, you can use Vike with any authentication tool such as:"}),`
...
`,e.jsxs(s.p,{children:["You can make information about the authenticated user available to your UI components and Vike hooks by defining a ",e.jsxs(n,{href:"/pageContext#custom",children:["custom property ",e.jsx(s.code,{children:"pageContext.user"})]})," in ",e.jsx(n,{href:"/onCreatePageContext",children:e.jsx(s.code,{children:"+onCreatePageContext.server.js"})}),"."]}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// pages/+onCreatePageContext.server.ts"})}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"  // vike-server exposes the request object at pageContext.runtime.req"})}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["You can access ",e.jsx(s.code,{children:"pageContext"})," in any UI component and Vike hook — see ",e.jsx(n,{href:"/pageContext"}),"."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(n,{href:"/vike-server",children:e.jsx(s.code,{children:"vike-server"})}),", you can access the request object at ",e.jsx(s.code,{children:"pageContext.runtime.req.user"})," (see ",e.jsx(n,{href:"/pageContext#runtime",children:e.jsx(s.code,{children:"pageContext.runtime"})}),")."]}),`
`,e.jsxs(s.p,{children:["If you don't use ",e.jsx(s.code,{children:"vike-server"}),", you can define a custom property ",e.jsx(s.code,{children:"pageContext.req"})," at ",e.jsx(n,{href:"/renderPage",children:e.jsx(s.code,{children:"renderPage()"})}),":"]}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// server/index.ts"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
...
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// pages/+onCreateGlobalContext.client.ts"})}),`
...
`]}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/admin/+guard.ts"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(s.span,{style:{color:"#D73A49"},children:" type"}),e.jsx(s.span,{style:{color:"#24292E"},children:" { PageContextServer } "}),e.jsx(s.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(s.span,{style:{color:"#032F62"},children:" 'vike/types'"})]}),`
...
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/+guard.ts"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
