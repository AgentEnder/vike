import{o as a,a as o}from"../chunks/chunk-C8vnCRJQ.js";import{j as e}from"../chunks/chunk-DbV7nHd1.js";import{L as l}from"../chunks/chunk-DLDxwuYb.js";/* empty css                      */import{W as r}from"../chunks/chunk-DFo3DYfP.js";import{C as t}from"../chunks/chunk-CiD4kU4l.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const d=[{pageSectionId:"window-is-not-defined",pageSectionLevel:2,pageSectionTitle:"`window is not defined`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(s){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Hints for how to resolve common issues."}),`
...
`})})}),`
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// ~/my-app/some/file.ts"})}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{className:"has-diff",style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// ~/my-app/somewhere/else.ts"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
...
`]}),`
`,e.jsx(r,{children:e.jsxs(n.p,{children:["Another common technique is to define the ",e.jsx(n.code,{children:"window"})," object on the server-side, for example with ",e.jsx(n.a,{href:"https://www.npmjs.com/package/ssr-window",children:e.jsx(n.code,{children:"ssr-window"})}),", but we recommend against this approach because it may break a library that relies on ",e.jsx(n.code,{children:"typeof window !== 'undefined'"})," to test whether the code is running on the client or server-side."]})}),`
`,e.jsxs(n.blockquote,{children:[`
