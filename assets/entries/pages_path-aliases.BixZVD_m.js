import{o as r,a as t}from"../chunks/chunk-C8vnCRJQ.js";import{j as e,b as l}from"../chunks/chunk-DbV7nHd1.js";import{L as i}from"../chunks/chunk-DLDxwuYb.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const o=[{pageSectionId:"vite",pageSectionLevel:2,pageSectionTitle:"Vite"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"node-js",pageSectionLevel:2,pageSectionTitle:"Node.js"}];function a(n){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:`Instead of using relative import paths,
which can be cumbersome,
you can use path aliases:`}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{className:"has-diff",style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsxs(s.span,{className:"diff remove","data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(s.span,{style:{color:"#24292E"},children:" { Counter } "}),e.jsx(s.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(s.span,{style:{color:"#032F62"},children:" '../../../../components/Counter'"})]}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:"vite.config.ts#resolve.alias"})," (for files processed by Vite)"]}),`
...
`,e.jsxs(s.p,{children:["If you don't use ",e.jsx(i,{href:"/vike-server",children:e.jsx(s.code,{children:"vike-server"})})," then your server files aren't processed by Vite — they are directly executed by Node.js. Therefore, you must configure Node.js to resolve your path aliases:"]}),`
