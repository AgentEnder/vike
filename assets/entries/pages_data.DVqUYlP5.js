import{o,a as i}from"../chunks/chunk-C8vnCRJQ.js";import{j as e,b as l}from"../chunks/chunk-DbV7nHd1.js";import{L as n}from"../chunks/chunk-DLDxwuYb.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{U as a}from"../chunks/chunk-CvpKDvio.js";/* empty css                      */import{C as c}from"../chunks/chunk-De_Aj9lY.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"orm-sql",pageSectionLevel:2,pageSectionTitle:"ORM/SQL"},{pageSectionId:"error-handling",pageSectionLevel:2,pageSectionTitle:"Error handling"},{pageSectionId:"environment",pageSectionLevel:2,pageSectionTitle:"Environment"},{pageSectionId:"client-js",pageSectionLevel:3,pageSectionTitle:"`.client.js`"},{pageSectionId:"shared-js",pageSectionLevel:3,pageSectionTitle:"`.shared.js`"},{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(r){const s={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{env:e.jsxs(e.Fragment,{children:["server (",e.jsx(n,{href:"#environment",children:"configurable"}),")"]}),cumulative:!1}),`
...
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/movies/+data.ts"})}),`
...
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"data()"})," hook is usually used together with the component hook ",e.jsx(n,{href:"/useData",children:e.jsx(s.code,{children:"useData()"})})," which is provided by the ",e.jsx(a,{}),"."]}),`
...
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["In case you don't use ",e.jsx(a,{name:!0,noLink:!0}),", you can implement ",e.jsx(s.code,{children:"useData()"})," yourself as shown at ",e.jsx(n,{href:"/useData#without-vike-react-vue-solid",doNotInferSectionTitle:!0})]}),`
`]}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /renderer/+onRenderClient.ts"})}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"  */"})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/movies/+Page.ts"})}),`
